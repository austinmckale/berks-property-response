...
export const triageCards = [
  {
    title: "Sewer backup or multiple drains",
    description: "Sewage, floor-drain overflow, or toilets and tubs backing up together.",
    href: "/emergency",
  ...
  },
  {
    ...
    description: "One sink, tub, shower, or toilet that drains slowly or keeps clogging.",
    href: "/drains",
  ...
  {
    title: "Leak at one fixture",
    description: "A dripping pipe, running toilet, faucet, supply line, or leak under a sink.",
  ...
  {
    title: "Damage after a leak or backup",
    description: "Wet drywall, ceiling stains, flooring, trim, or other damage after the source is stopped.",
    href: "/after-leak",
  ...
  },
  {
    ...
    description: "Smoke, storm damage, suspected mold, roof leaks, or a problem that doesn’t fit above.",
